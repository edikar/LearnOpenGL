...
int main()
{
    ...
    Shader screenShader_sharpen("shaders/screenShader.vs", "shaders/screenShader_sharpen.fs");
    Shader screenShader_blur("shaders/screenShader.vs", "shaders/screenShader_blur.fs");
    Shader screenShader_edge("shaders/screenShader.vs", "shaders/screenShader_edge.fs");
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        //screenShader.use();  
        //screenShader_sharpen.use();  
        screenShader_blur.use();  
        //screenShader_edge.use();  
        glBindVertexArray(quadVAO);
