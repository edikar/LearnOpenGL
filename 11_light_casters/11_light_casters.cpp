...
//light position
glm::vec3 lightPos(5.0f, -0.5f, 0.0f); // for point light
glm::vec3 lightDir(-0.2f, -0.2f, -1.3f); // for directional light
...
int main()
{
    ...
    Shader lightingShader("shaders/dirLightShader.vs", "shaders/dirLightShader.fs");
#elif defined POINT_LIGHT
    Shader lightingShader("shaders/pointLightShader.vs", "shaders/pointLightShader.fs");
#elif defined SPOT_LIGHT
    Shader lightingShader("shaders/spotLightShader.vs", "shaders/spotLightShader.fs");
#else
    #error "define a light type!"
#endif
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        //lightingShader.setInt("material.specularMap", 0);
        lightingShader.setInt("diffuseMap", 0);
        lightingShader.setInt("specularMap", 1);
        lightingShader.setInt("emissionMap", 2);
        lightingShader.setVec3("material.specular", glm::vec3(0.5f, 0.5f, 0.5f));
        lightingShader.setFloat("material.shininess", 32.0f);
        lightingShader.setVec3("light.ambient",  glm::vec3(0.2f, 0.2f, 0.2f));
        lightingShader.setVec3("light.diffuse",  glm::vec3(0.99f, 0.99f, 0.99f)); // darken the light a bit to fit the scene
        ...
        lightingShader.setFloat("light.cutOff",   glm::cos(glm::radians(12.5f))); //sending cosine to save performance in FS
        lightingShader.setFloat("light.outerCutOff",   glm::cos(glm::radians(17.5f))); //sending cosine to save performance in FS
#endif
        ...
        // bind emission map for cube object
